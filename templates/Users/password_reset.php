                    ...
                    <div class="col-lg-6 order-lg-1 mb-5 mb-lg-0">
                        <div class="container-fluid px-5">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <h5 class="text-white text-center bg-gradient-primary-to-secondary p-2">Password reset</h5>
                            ...
                            <div class="row">
                                <!-- <button class="btn btn-primary rounded-pill btn-lg disabled" id="submitButton" type="submit">Submit</button> -->
                                 <div class="col-6">
                                     <?= $this->Form->button(__('Send OTP'),['class'=>'btn btn-primary rounded-pill btn-lg', 'style' => 'width: 100%']) ?>
                                 </div>
                                 <div class="col-6">
                                     <?php 
                                echo $this->Html->link(
