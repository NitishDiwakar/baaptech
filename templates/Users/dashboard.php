                    ...
                    <div class="col-md-9">
                        ...
                        <?= $this->Form->create($donation) ?>
                            ...
                            <div class="row">
                                ...
                                <?php  echo $this->Form->control('full_name', ['class' => 'form-control']); ?>
                            ...
                            <div class="row">
                                ...
                                <?php  echo $this->Form->control('mobile', ['class' => 'form-control']); ?>
                            ...
                            <div class="row">
                                ...
                                <?php  echo $this->Form->control('city', ['class' => 'form-control', 'label' => 'City']); ?>
                                <!-- <label for="email">Email address</label> -->
                            ...
                            <div class="row">
                                ...
                                <?php  echo $this->Form->control('amt_donated', ['class' => 'form-control', 'label' => 'Amount Donated']); ?>
                                ...
                                <?php  echo $this->Form->control('bank_refno', ['class' => 'form-control', 'label' => 'Bank Reference #']); ?>
                                <!-- <label for="email">Email address</label> -->
