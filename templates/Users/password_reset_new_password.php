                    ...
                    <div class="col-lg-6 order-lg-1 mb-5 mb-lg-0">
                        <div class="container-fluid px-5">
                            ...
                            <!-- <form id="contactForm1" data-sb-form-api-token="API_TOKEN"> -->
                                <!--  -->
                                <?php  
                                // echo $this->request->getSession()->read('temp_otp');
                                ?>
                            <?= $this->Form->create($user) ?>
                            <!-- Name input-->
                            <?php  
                            $temp_uid = $this->request->getSession()->read('temp_uid');
                            ?>
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
                                ...
                                <h5 class="text-white text-center bg-gradient-primary-to-secondary p-2">Enter New Password</h5>
                                 
                                <?php  echo $this->Form->control('password', ['class' => 'form-control', 'label' => 'Enter New Password', 'required']); ?>
                                
                                <?php  echo $this->Form->control('password_r', ['class' => 'form-control', 'type' => 'password', 'label' => 'Retype New Password', 'required']); ?>
                            </div>
                            ...
                            <div class="row">
                                 <div class="col-6">
                                     <?= $this->Form->button(__('Reset Password'),['class'=>'btn btn-primary rounded-pill btn-lg', 'style' => 'width: 100%']) ?>
                                 </div>
                                 <div class="col-6">
