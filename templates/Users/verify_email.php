                ...
                <div class="row gx-5 align-items-center" style="margin-top: 2%">
                    <div class="col-lg-6 order-lg-1 mb-5 mb-lg-0">
                        <div class="container-fluid px-5">
                            ...
                            <!-- Name input-->
                            <legend><?= __('Verify email') ?></legend>
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
                                <!-- <input class="form-control" id="email" type="email" placeholder="name@example.com" data-sb-validations="required,email" /> -->
                                <?php  echo $this->Form->control('otp', ['class' => 'form-control', 'label' => 'Enter OTP you received in your email']); ?>
                            ...
                            <div class="d-grid">
                                <!-- <button class="btn btn-primary rounded-pill btn-lg disabled" id="submitButton" type="submit">Submit</button> -->
                                 <?= $this->Form->button(__('verify'),['class'=>'btn btn-primary rounded-pill btn-lg']) ?>
                            </div>
                        <!-- </form> -->
                        <?= $this->Form->end() ?>
                        <div class="row">
