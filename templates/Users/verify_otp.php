                    ...
                    <div class="col-lg-6 order-lg-1 mb-5 mb-lg-0">
                        <div class="container-fluid px-5">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <h5 class="text-white text-center bg-gradient-primary-to-secondary p-2">Verify OTP</h5>
                                 
                                <?php  echo $this->Form->control('otp', ['class' => 'form-control', 'required', 'maxlength' => 6, 'label' => 'Enter OTP sent to your email']); ?>
                            ...
                            <div class="row">
                                 <div class="col-6">
                                     <?= $this->Form->button(__('Verify OTP'),['class'=>'btn btn-primary rounded-pill btn-lg', 'style' => 'width: 100%']) ?>
                                 </div>
                                 <div class="col-6">
