...
<button id="show1" class="Button Button--primary IndexPage-newDiscussion hasIcon" type="button" itemclassname="App-primaryControl"><i aria-hidden="true" class="icon fa fa-edit Button-icon"></i><span class="Button-label">Post Reply</span></button>
