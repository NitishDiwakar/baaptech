...
<head>
    ...
    <title>BAAP ADMIN - Categories</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?php echo $this->Url->build('/manage/category_add');?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fa fa-add fa-sm text-white-50"></i> Add Category</a>
