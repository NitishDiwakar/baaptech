...
<head>
    ...
    <title>BAAP Admin - Category Edit</title>
...
<!-- Submit Button-->
    <div class="d-grid">
         <?= $this->Form->button(__('Update Category'),['class'=>'btn btn-sm btn-primary shadow-sm']) ?>
    </div>
                        <!-- </form> -->
                        <?= $this->Form->end() ?>
    </div>
