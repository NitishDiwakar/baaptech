...
<head>
    ...
    <title>BAAP ADMIN - Suggestions</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <!-- <a href="<?php echo $this->Url->build('#/manage/');?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-add fa-sm text-white-50"></i> </a> -->
...
<table class="table" id="myTable">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          <a title="Delete Event" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure, you want to delete this event?')" href="<?php echo $this->Url->build('/manage/suggestions_delete?id='.$result['id'].' ');?>"><i class="fa fa-trash"></i></a>
