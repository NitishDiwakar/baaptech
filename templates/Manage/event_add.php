...
<div class="row">
    <div class="col-6">
        <div class="form-floating mb-3">
        <?php  echo $this->Form->control('start_date', ['class' => 'form-control', 'label' => 'Start Date', 'type' => 'date', 'required']); ?>
</div>
    </div>
    <div class="col-6">
        <div class="form-floating mb-3">
        <?php  echo $this->Form->control('end_date', ['class' => 'form-control', 'label' => 'End Date', 'type' => 'date', 'required']); ?>
</div>
    </div>
</div>
